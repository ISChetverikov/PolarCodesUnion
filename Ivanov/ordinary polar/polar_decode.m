function [u, v, out_llr] = polar_decode(y, frozen_bits_indicator,in_llr,inv_bit_numb)
...
if N == 2
    ...
    i=length(out_llr);
    if ismember(i,inv_bit_numb) %flipping
        u(1)=1-u(1);
    end
    L_u_2 = g(y(1), y(2), u(1));
    ...
    [u_1, v_1,out_llr] = polar_decode(L_w_odd, frozen_bits_indicator_1,out_llr,inv_bit_numb);
    ...
    [u_2, v_2,out_llr] = polar_decode(L_w_even, frozen_bits_indicator_2,out_llr,inv_bit_numb);
